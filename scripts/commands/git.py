...
def stage():
    ...
    file_status = [(line[:2].strip(), line[2:].strip()) for line in changed_files]

    console.print("[cyan]Select files to stage...[/cyan]")
    ...
    if staged_files:
        console.print("[cyan]Select files to unstage if necessary...[/cyan]")
